		...
		try 
		{
			...
			else
			{
				...
				if ($wszystko_OK==true)
				{
					...
					if ($polaczenie->query("INSERT INTO users VALUES (NULL, '$nick', '$haslo_hash', '$email', '$imie', '$nazwisko')") and $polaczenie->query("INSERT INTO logi VALUES (NULL, '$nick', '$data', '$ip', '$proby', '$dataerror', '$iperror', 0)"))
					{
                        $path = 'katalogi' . DIRECTORY_SEPARATOR . $_POST['nick'];
    								if(!is_dir($path)) {
...
<head>
	...
	<title>Sieminski - Rejestracja</title>
